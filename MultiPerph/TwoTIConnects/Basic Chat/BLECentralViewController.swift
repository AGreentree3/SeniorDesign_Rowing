...
// Question Mark marks a value as optional. Optional variables either contain a value or contain nil to indicate that the value is missing. You can then use 'if let x = optional value' which is false if the optional value is nil and x = value if optional value is not nil
...
class BLECentralViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    func disconnectFromDevice (deviceNum: Int) {
        centralManager.cancelPeripheralConnection(blePeripherals[deviceNum]!)
    ...
    func connectToDevice (deviceNum: Int) {
        centralManager?.connect(blePeripherals[deviceNum]!, options: nil)
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        if deviceIndex==numDevices{
            ...
            print(blePeripherals[0]!.name!)
            print(blePeripherals[1]!.name!)
            uartViewController.peripherals = blePeripherals
            //^^^^
    ...
    /*
     ...
     This method is invoked when your app calls the discoverServices(_:) method. If the services of the peripheral are successfully discovered, you can access them through the periph eral’s services property. If successful, the error parameter is nil. If unsuccessful, the error parameter returns the cause of the failure.
     */
    ...
    */
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        blePeripherals.append(peripherals[indexPath.row])//this will need to be updated
        connectToDevice(deviceNum: deviceIndex)
    }
